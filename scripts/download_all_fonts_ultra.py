...
# Verified sources after research
FONT_SOURCES = [
    {
        "id": "seoul_hangang",
        "name": "SeoulHangangB.ttf",
        "urls": ["http://www.seoul.go.kr/v2012/seoul/symbol/file/SeoulHangangB.ttf"]
    },
    {
        "id": "pretendard",
    ...
    },
    {
        ...
        "extract_files": ["GmarketSansTTFBold.ttf", "GmarketSansTTFMedium.ttf"]
    },
    {
        "id": "ibm_plex",
    ...
    },
    {
        ...
        "urls": [
            "https://raw.githubusercontent.com/webfontworld/cafe24/main/Cafe24Ssurround.ttf",
    ...
    },
    {
        ...
        "is_zip": True,
        "urls": ["https://github.com/naver/nanumfont/archive/refs/heads/master.zip"],
                        ...
                        for file_to_extract in source["extract_files"]:
                            for zip_name in zf.namelist():
                                if zip_name.endswith(file_to_extract):
                                    dest_path = os.path.join(FONTS_DIR, file_to_extract)
...
def main():
    logger.info("=" * 60)
    logger.info("FINAL Font Synchronizer for Shopping Shorts Maker")
    logger.info("=" * 60)
    ...
    # Check what we have
    logger.info("\nFinal Font List in fonts/ directory:")
