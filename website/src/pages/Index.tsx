    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="sr-only" aria-label="서비스 요약 정보">
        ...
        <p>
          ...
          수 있도록 설계된 AI 자동화 솔루션입니다. GPU 가속으로 영상 4개를 동시에 처리할 수 있습니다.
        </p>
        ...
        <p>
          ...
          최대 4개 영상 병렬 일괄 처리를 지원합니다. MP4, AVI, MKV, MOV 등 대부분의 영상 형식을 지원합니다.
        </p>
        <h2>SSMaker 가격 및 요금제</h2>
        <p>
          무료 체험은 로그인 계정 기준 매월 5회 제공되며 모든 기능을 동일하게 사용할 수 있습니다. 프로 월 정액은 월 149,000원으로
          무제한 제작, GPU 가속, 병렬 처리, 우선 고객 지원이 포함됩니다. 라이선스는 1인 1PC 기준입니다.
        </p>
